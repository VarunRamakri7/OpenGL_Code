/**
	Program to draw the vertices of a tesselated triangle
**/

#include <sb7.h>

class TesselatedTriangleVertices : public sb7::application
{
	void init()
	{
		static const char title[] = "Tesselation and Geometry Shaders";
...
// Declare entry point
DECLARE_MAIN(TesselatedTriangleVertices);